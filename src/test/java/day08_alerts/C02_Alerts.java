...
public class C02_Alerts {
    ...
    public void acceptAlert(){
        ...
        driver.switchTo().alert().accept();  // cikan OK yazisini tikladikn
    ...
    public void dismissAlert(){
        ...
        driver.switchTo().alert().dismiss();  // uyariya gecmek icin switchTo kullaniyoruz
    ...
    public void sendKeysAlert() {
        ...
        driver.switchTo().alert().sendKeys("QA guzel");
