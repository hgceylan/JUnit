...
public class C04_Assertions {
    ...
    @Test
    public void test01(){
        // eger test methodumuzda hiocbir test yoksa,test calistiktan sonra
        // hicbir problemle karsilasilmadigini raporlamak icin test passed yazisi cikar

        // eget testleri if ile yaparsak test failed olsa bile kodlar problemsiz calistigi icin
        // kod calismasi bitttiginde ekranin sol alt kisminda  test passed yazacaktir
 ...
 */
        ...
        Java kodlarin calismasini durdurur ve Assert classi bizi hata konusunda
         bilgilendirir
