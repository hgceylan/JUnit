...
public class C03_Actions extends TestBase {
    ...
    public void test01(){
        ...
        driver.switchTo().alert().accept();  // tamam demek icin


        //6- Elemental Selenium linkine tiklayalim
        String ilkSayfaWindowHandleDegeri=driver.getWindowHandle();  // ilk sayfanin handle degeri
        driver.findElement(By.xpath("//*[text()='Elemental Selenium']")).click(); // diger sayfaya gecis
        Set<String> handleSeti=driver.getWindowHandles(); // diger sayfalarla birlikte tum sayfalarin handle degeri
        ...
        for (String each:handleSeti
            ...
            if( !each.equals(ilkSayfaWindowHandleDegeri)){
                ikinciWHDegeri=each;    // ikinci sayfanin windowHandle degerini elde etmis olacam
            }
