...
public class C02_webTables extends TestBase {
    ...
    public void webTable() {
        ...
        // tum body i String olarak yazdirmak isterseniz
        // body ve webElementini locate edip,getText() method'u ile yazdirabilirisniz

        WebElement tumBady=driver.findElement(By.xpath("//tbody"));
        System.out.println(tumBady.getText());

        //● printRows( ) metodu oluşturun //tr
        //○ table body’sinde bulunan toplam satir(row) sayısını bulun.L
        ...
        //email basligindaki tum elemntleri (sutun)konsolda yazdirin
        // once email basligini kacinci sutunda oldugunu bulalim
        ...
        List<WebElement> emailSutunListesi=
                driver.findElements(By.xpath("//tbody//td["+(emailSutunNo+1)+"]"));  // +1 sebebi liste birden basliyor
              //                                                 //tbody//td[3]
